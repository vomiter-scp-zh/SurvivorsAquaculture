...
public abstract class NeptuniumArmor_EffectMixin extends ArmorItem {
    ...
    @WrapOperation(method = "onArmorTick", at = @At(value = "INVOKE", target = "Lnet/minecraft/world/entity/player/Player;addEffect(Lnet/minecraft/world/effect/MobEffectInstance;)Z", ordinal = 0, remap = true))
